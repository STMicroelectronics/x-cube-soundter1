...
#ifndef NUCLEO_F072RB_BUS_H
#define NUCLEO_F072RB_BUS_H
...
/* Includes ------------------------------------------------------------------*/
#include "nucleo_f072rb_conf.h"
#include "nucleo_f072rb_errno.h"
...
/** @defgroup NUCLEO_F072RB_BUS_Exported_Constants NUCLEO_F072RB BUS Exported Constants
  * @{
  */
...
/** @defgroup NUCLEO_F072RB_BUS_Private_Types NUCLEO_F072RB BUS Private types
  * @{
  */
...
/** @defgroup NUCLEO_F072RB_LOW_LEVEL_Exported_Variables LOW LEVEL Exported Constants
  * @{
  */ 
...
/** @addtogroup NUCLEO_F072RB_BUS_Exported_Functions
  * @{
  */    
