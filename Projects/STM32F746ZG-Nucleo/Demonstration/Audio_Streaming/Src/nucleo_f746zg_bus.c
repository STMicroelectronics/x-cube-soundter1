...
/** @addtogroup NUCLEO_F746ZG
  * @{
  */

/** @defgroup NUCLEO_F746ZG_BUS NUCLEO_F746ZG BUS
  * @{
  */


/** @defgroup NUCLEO_F746ZG_Private_Variables BUS Private Variables
  * @{
  */
...
/** @defgroup NUCLEO_F746ZG_Private_FunctionPrototypes  Private Function Prototypes
  * @{
  */
...
/** @defgroup NUCLEO_F746ZG_LOW_LEVEL_Private_Functions NUCLEO_F746ZG LOW LEVEL Private Functions
  * @{
  */

/** @defgroup NUCLEO_F746ZG_BUS_Exported_Functions NUCLEO_F746ZG_BUS Exported Functions
  * @{
  */
...
__weak HAL_StatusTypeDef MX_I2C1_Init(I2C_HandleTypeDef *hi2c)
{
  ...
  hi2c->Instance = I2C1;
  hi2c->Init.Timing = NUCLEO_I2C_EXPBD_TIMING_400KHZ;
